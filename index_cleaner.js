...
app.get('/users/:id', (req, res) => {
  ...
  const userItemsById = items.reduce((acc, item) => item.user_id === user.id ? [...acc, item.id] : acc, [])
  ...
  const userTransactions = transactions.filter(transaction => userAccountsById.includes(transaction.account_id))
